...
<?php endif; ?>
    ...
    <form
        action="<?php echo e(route('guardians.store')); ?>"
        method="POST"
    >
        <?php echo csrf_field(); ?>
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-4 lg:p-6">
            ...
            <div class="<?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin')): ?> lg:grid-cols-2 <?php endif; ?> mb-4 grid grid-cols-1 gap-4">
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin')): ?>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            name="hei_id"
                        >
                            <option <?php echo e(old('hei_id') ? '' : 'selected'); ?>>---</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    >
                        <option
                            value=""
                            <?php echo e(old('student_id') ? '' : 'selected'); ?>
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                ...
                                <?php echo e(old('faculty_id') == $student->id ? 'selected' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/pages/guardians/create.blade.php ENDPATH**/ ?>