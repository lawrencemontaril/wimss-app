    ...
    <div class="mb-4 grid w-full grid-cols-12 gap-4">
        <div class="col-span-full lg:col-span-9">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'student', $user)): ?>
                ...
                <?php if($user->profile->is_graded): ?>
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        ...
                        <div class="col-span-2 rounded-xl border border-zinc-200 bg-white shadow-sm">
                            ...
                            <div class="p-4">
                                <?php echo e($user->profile->recom ?? 'No remarks.'); ?>
                ...
                <?php if(!empty($user->profile->recommendations)): ?>
                    <div class="mt-4 rounded-xl border border-zinc-200 bg-white shadow-sm">
                        ...
                        <div class="p-4">
                            <ul class="ms-4 list-disc">
                                <?php $__currentLoopData = $user->profile->recommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="mb-1.5">
                                        <strong><?php echo e($rec['label']); ?> (<?php echo e($rec['score']); ?>/5):</strong>
...
<?php echo $__env->make('layouts.dashboard-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\_projects\wimss\resources\views/pages/users/show.blade.php ENDPATH**/ ?>