<?php $__env->startSection('title', '- Create an HEI'); ?>
...
<?php endif; ?>
    ...
    <form
        action="<?php echo e(route('heis.store')); ?>"
        method="POST"
    >
        <?php echo csrf_field(); ?>
...
<?php $component = App\View\Components\TextInput::resolve(['name' => 'name','type' => 'text','value' => ''.e(old('name')).'','labelText' => 'Name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="mb-4">
                <?php if (isset($component)) { $__componentOriginal3cf47f8fe36e9fecb8ab96f4432c11f7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3cf47f8fe36e9fecb8ab96f4432c11f7 = $attributes; } ?>
<?php $component = App\View\Components\TextInput::resolve(['name' => 'address','type' => 'text','value' => ''.e(old('address')).'','labelText' => 'Address'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\_projects\wimss\resources\views/pages/heis/create.blade.php ENDPATH**/ ?>