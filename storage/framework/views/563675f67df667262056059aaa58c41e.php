...
<?php endif; ?>
    ...
    <form
        action="<?php echo e(route('faculties.store')); ?>"
        method="POST"
    >
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/pages/faculties/create.blade.php ENDPATH**/ ?>