...
<?php endif; ?>
                ...
                <a
                    class="flex items-center gap-2 rounded-lg bg-sky-500 px-3 py-2 text-xs text-sky-50 hover:bg-sky-400"
                    href="<?php echo e(route('students.import')); ?>"
                >
                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export', \App\Models\Student::class)): ?>
            <a
                class="flex items-center gap-2 rounded-lg bg-green-500 px-3 py-2 text-xs text-green-50 hover:bg-green-400 sm:w-auto"
                href="<?php echo e(route('students.export')); ?>"
            >
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Recommendation <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160)): ?>
<?php $attributes = $__attributesOriginal1291f4dfa458a95c228b06c14d34e160; ?>
<?php unset($__attributesOriginal1291f4dfa458a95c228b06c14d34e160); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.row','data' => ['href' => ''.e(route('users.show', $student->username)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('users.show', $student->username)).'']); ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-2">
                                    <a
                                        ...
                                        href="<?php echo e(route('heis.show', $student->profile->hei->id)); ?>"
                                    >
                                        <?php echo e($student->profile->hei->name); ?>
...
<?php $component->withAttributes([]); ?>
                            ...
                            <div class="flex items-center gap-2">
                                <a
                                    href="<?php echo e(route('students.grades-show', $student->profile)); ?>"
...
<?php endif; ?>
                                    <span class="hidden md:inline">
                                        <?php echo e($student->profile->isPassed ? 'Absorbed' : ''); ?>

                                        <?php echo e($student->profile->isFailed ? 'Not absorbed' : ''); ?>

                                        <?php echo e($student->profile->isPending ? 'Pending' : ''); ?>

                                    </span>
                                    <?php if(!$student->profile->isPending): ?>
                                        <span>(<?php echo e($student->profile->final_grade); ?>)</span>
                                    <?php endif; ?>
                                </a>
                            </div>
                         <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-4">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $student->profile)): ?>
                                        <a
                                            class="group inline-flex items-center justify-center gap-1 text-yellow-600"
                                            href="<?php echo e(route('users.edit', $student->username)); ?>"
                                        >
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $student->profile)): ?>
                                        <button
                                            class="delete-btn group inline-flex items-center justify-center gap-1 text-red-600"
                                            data-modal-target="delete-modal"
                                            data-modal-toggle="delete-modal"
                                            data-url="<?php echo e(route('students.destroy', $student->profile)); ?>"
                                            type="button"
                                        >
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
    ...
    <div>
        <?php echo e($students->onEachSide(1)->links('vendor.pagination.tailwind')); ?>

    </div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/pages/students/index.blade.php ENDPATH**/ ?>