...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(($ug_students->currentPage() - 1) * $ug_students->perPage() + $loop->index + 1); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2549586849-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2549586849-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2549586849-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/components/dashboard/hte-dashboard.blade.php ENDPATH**/ ?>