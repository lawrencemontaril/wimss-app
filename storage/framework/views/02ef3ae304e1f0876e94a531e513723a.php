...
<?php endif; ?>
    ...
    <div class="mb-4 flex items-center justify-between gap-1 rounded-xl border border-zinc-200 bg-white p-1">
        <div class="flex items-center gap-1">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Faculty::class)): ?>
                <a
                    class="flex items-center gap-2 rounded-lg bg-sky-500 px-3 py-2 text-xs text-sky-50 hover:bg-sky-400"
                    href="<?php echo e(route('faculties.create')); ?>"
                >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.row','data' => ['href' => ''.e(route('users.show', $faculty->username)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('users.show', $faculty->username)).'']); ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-2">
                                    <a
                                        ...
                                        href="<?php echo e(route('heis.show', $faculty->profile->hei->id)); ?>"
                                    >
                                        <?php echo e($faculty->profile->hei->name); ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center gap-4">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $faculty->profile)): ?>
                                        <a
                                            class="group inline-flex items-center justify-center gap-1 text-yellow-600"
                                            href="<?php echo e(route('users.edit', $faculty->username)); ?>"
                                        >
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $faculty->profile)): ?>
                                        <button
                                            class="delete-btn group inline-flex items-center justify-center gap-1 text-red-600"
                                            data-modal-target="delete-modal"
                                            data-modal-toggle="delete-modal"
                                            data-url="<?php echo e(route('faculties.destroy', $faculty->profile)); ?>"
                                            type="button"
                                        >
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
    ...
    <div>
        <?php echo e($faculties->onEachSide(1)->links('vendor.pagination.tailwind')); ?>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/pages/faculties/index.blade.php ENDPATH**/ ?>