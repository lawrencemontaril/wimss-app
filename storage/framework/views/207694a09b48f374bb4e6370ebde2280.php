...
<?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    id="description"
                    name="description"
                    value="<?php echo e(old('description', $course->description)); ?>"
                    rows="3"
                ></textarea>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/pages/courses/edit.blade.php ENDPATH**/ ?>