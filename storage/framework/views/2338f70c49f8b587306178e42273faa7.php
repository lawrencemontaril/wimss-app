<div class="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
    <?php if($student->likert_total): ?>
        <div class="rounded-xl border border-green-600 bg-green-500 text-green-50">
            <div class="border-b border-green-600 p-2 px-4">
                <p class="text-sm"><?php echo e($student->hte->name); ?> has rated your child.</p>
            </div>
    ...
    <?php if($student->adviser_rating): ?>
        <div class="rounded-xl border border-green-600 bg-green-500 text-green-50">
            <div class="border-b border-green-600 p-2 px-4">
                <p class="text-sm">
                    <?php echo e($student->faculty->user->full_name); ?> has rated your child.
                </p>
            </div>
            <div class="relative flex min-h-64 items-center p-2">
                <div class="w-3/5 rounded-md bg-green-600 p-2">
...
<?php /**PATH /home/wimssph/public_html/wimss_prod/resources/views/components/dashboard/guardian-dashboard.blade.php ENDPATH**/ ?>