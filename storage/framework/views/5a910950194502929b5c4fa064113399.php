...
<?php endif; ?>
    ...
    <form
        action="<?php echo e(route('users.update', ['user' => $user->username])); ?>"
        method="POST"
    >
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="mb-4">
                ...
                >
                    <option
                        value=""
                        <?php echo e(old('sex', $user->sex) ? '' : 'selected'); ?>

                    >---</option>

                    <option
                        value="male"
                        <?php echo e(old('sex', $user->sex) == 'male' ? 'selected' : ''); ?>
                    ...
                    <option
                        value="female"
                        <?php echo e(old('sex', $user->sex) == 'female' ? 'selected' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\_projects\wimss\resources\views/pages/users/edit.blade.php ENDPATH**/ ?>